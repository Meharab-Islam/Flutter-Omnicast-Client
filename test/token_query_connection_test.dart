...
void main() {
  ...
  group('WebSocket URL Token Appending & Auto-Generation', () {
    test(
      'SignalingClient stores and formats token into WebSocket URL query',
      () async {
        ...
        const testToken =
            'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJ1c2VyXzEifQ.xyz';
    ...
    test(
      'RoomManager generates token and executes connection with token attached',
      () async {
        ...
        try {
          await roomManager.createRoom(roomId: 'room_101', userId: 'host_42');
        } catch (_) {}
