...
void main() {
  ...
  group('VideoParameters Presets & Constraints', () {
    ...
    test(
      'WebRTCManager default rtcConfiguration sets unrestricted UDP iceTransportPolicy',
      () {
    ...
    test(
      'WebRTCManager setInitialBitrate injects x-google bitrates into fmtp',
      () {
        const sampleSdp =
            'v=0\r\nm=video 9 UDP/TLS/RTP/SAVPF 96\r\na=rtpmap:96 H264/90000\r\na=fmtp:96 level-asymmetry-allowed=1\r\n';
        final bitratedSdp = WebRTCManager.setInitialBitrate(
          sampleSdp,
          startKbps: 500,
          minKbps: 150,
          maxKbps: 800,
    ...
    test('WebRTCManager enableOpusDtx injects usedtx=1 into Opus fmtp line', () {
      ...
      expect(
        dtxSdp,
        contains('a=fmtp:111 minptime=10;usedtx=1;useinbandfec=1'),
      );
    });
