...
void main() {
  ...
  group('Late Joiner State Synchronization & Helper Facades', () {
    test(
      'syncRoomInfo populates active seats, mic/cam mute states, and counts for late joiners',
      () {
        ...
        roomState.syncRoomInfo({
          ...
          'active_seats': {'1': 'user-bob', '2': 'user-carol'},
          'waiting_list': [
            {
  ...
  group('Customizable Builders & Widgets', () {
    ...
    testWidgets(
      'OmniCastLiveRoomsBuilder gives developer 100% custom UI control',
      (tester) async {
    ...
    testWidgets(
      'OmniCastStageBuilder gives developer 100% custom stage design control',
      (tester) async {
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
                  ...
                  return Column(
                    children: [
                      ...
                      for (final s in seats)
                        Text('Seat ${s.seatIndex}: ${s.userId}'),
                    ],
                  );
                },
              ),
        ...
        client.state.updateActiveSeats({'1': 'player-one', '2': 'player-two'});
    ...
    testWidgets(
      'OmniCastStageGrid renders customizable seats with mic indicators',
      (tester) async {
        client.state.updateActiveSeats({'1': 'cohost-vip'});
        client.state.updateUserMediaState(
          'cohost-vip',
          isMuted: true,
          isCameraOff: true,
        );
    ...
    test(
      'RoomState does not throw if reset or notifyListeners called after dispose',
      () {
