...
## Corpus Check
- 54 files · ~28,870 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1064 nodes · 1325 edges · 37 communities (34 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1a4dfe52`
...
## Knowledge Gaps
- **793 isolated node(s):** `config`, `_client`, `getLiveRooms`, `dispose`, `OmniCastTokenGenerator` (+788 more)
