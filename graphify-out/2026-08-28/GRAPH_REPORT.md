...
## Summary
- 746 nodes · 891 edges · 31 communities (25 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `265a3bf0`
...
Cohesion: 0.04
Nodes (53): ClientConnectionState, ClientConnectionState get, _answerController, _channel, _channelSubscription, _chatController, _cleanupActiveConnection, connect (+45 more)
...
Cohesion: 0.04
Nodes (46): ../interaction/interaction_manager.dart, InteractionManager, InteractionManager get, _bindInternalEventListeners, config, dispose, init, _initSubManagers (+38 more)

### Community 4 - "media_controller.dart"
Cohesion: 0.04
Nodes (44): global_media_config.dart, GlobalMediaConfig get, autoPauseOnBackground, defaultResolution, enableAdaptiveStreaming, enableDynacast, enableSimulcast, GlobalMediaConfig (+36 more)

### Community 5 - "gift_overlay_manager.dart"
Cohesion: 0.05
Nodes (40): Alignment, Duration, GiftEvent, heartbeatInterval, hostUrl, iceServers, maxReconnectAttempts, OmniCastConfig (+32 more)
...
Cohesion: 0.06
Nodes (35): ChangeNotifier, activeSeatsNotifier, activeViewersList, _batchDebounceTimer, _bindSignalingEvents, _bindStateNotifiers, connectionStateNotifier, createRoom (+27 more)
...
Cohesion: 0.07
Nodes (29): int get, avatarUrl, ClientConnectionState, copyWith, displayName, enableAudio, enableDynacast, enableSimulcast (+21 more)

### Community 12 - "interaction_manager.dart"
Cohesion: 0.07
...
### Community 13 - "media_stream_manager.dart"
Cohesion: 0.07
...
### Community 14 - "dart:async"
Cohesion: 0.11
Nodes (16): dart:async, dart:convert, package:flutter/material.dart, package:flutter_test/flutter_test.dart, package:flutter/widgets.dart, package:omnicast_client/omnicast_client.dart, main, main (+8 more)

### Community 15 - "seat_models.dart"
Cohesion: 0.08
Nodes (23): bool get, DateTime, CoHostInvite, createdAt, fromJson, hostId, inviteId, isLocked (+15 more)
...
## Knowledge Gaps
- **555 isolated node(s):** `_activePK`, `_activeRemoteUserIds`, `_activeSeats`, `addActiveRemoteUser`, `addChatMessage` (+550 more)
...
- **Why does `RoomState` connect `room_manager.dart` to `room_state.dart`, `core/omnicast_client.dart`, `media_controller.dart`?**
