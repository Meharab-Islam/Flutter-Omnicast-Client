...
## Summary
- 756 nodes · 901 edges · 32 communities (25 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23251a95`
...
2. `Participant` - 3 edges
3. `OmniCastConfig` - 3 edges
4. `PKState` - 3 edges
5. `MediaController` - 3 edges
6. `RoomState` - 3 edges
7. `GiftOverlayManager` - 3 edges
8. `_GiftOverlayManagerState` - 3 edges
9. `OmniCastVideoView` - 3 edges
10. `_OmniCastVideoViewState` - 3 edges
...
### Community 3 - "media_controller.dart"
Cohesion: 0.04
Nodes (46): ChangeNotifier, global_media_config.dart, GlobalMediaConfig get, autoPauseOnBackground, defaultResolution, enableAdaptiveStreaming, enableDynacast, enableSimulcast (+38 more)
...
### Community 8 - "gift_overlay_manager.dart"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (21): Axis, build, _buildVideoPane, hostDisplayName, hostPlaceholder, hostUserId, mediaStreamManager, objectFit (+13 more)
...
## Knowledge Gaps
- **560 isolated node(s):** `_activePK`, `_activeRemoteUserIds`, `_activeSeats`, `addActiveRemoteUser`, `addChatMessage` (+555 more)
...
- **Why does `SignalingClient` connect `interaction_manager.dart` to `seat_manager.dart`, `signaling_client.dart`, `pk_manager.dart`?**
